            ...
            <div className="form">
                ...
                <div className="form-input">
                    <div className="input-group">
                        <input type="password" placeholder="password" onChange={this.props.handleChange('password')}></input>
                    </div>
                    <div className="input-group" >
                        <input  type="password" placeholder="confirm password" onChange={this.props.handleChange('cpassword')}></input>
                    </div>
                </div>
                <div className="form-input">
                <div className="input-group">
                        <input type="date" placeholder="dob" onChange={this.props.handleChange('dob')}></input>
                    </div>
                </div>
                <div className="form-action">
                    <button className="step-button" onClick={this.handleClick}>Next Step</button>
                    <button className="step-button" onClick={this.handleClick}>Prev Step</button>
                </div>
            </div>
        );
    }
